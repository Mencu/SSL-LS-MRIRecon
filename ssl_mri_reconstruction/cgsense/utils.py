...
def uniform_selection(input_data, input_mask, rho=0.2, small_acs_block=(4, 4)):
    """
    :param rho: Sampling ratio for uniform sampling (int)
    """
    ...
    for phase in range(input_mask.shape[0]):
        ...
        # medutils.visualization.imsave(inp_mask[0],f'inp_mask_0.png')
        # medutils.visualization.imsave(inp_mask[1],f'inp_mask_1.png')
        # medutils.visualization.imsave(inp_mask[2],f'inp_mask_2.png')
        ...
        # print(f'kx: {center_kx} and ky {center_ky}')
        ...
        # medutils.visualization.imsave(inp_mask[0],f'inp_mask_{phase}.png')
        # medutils.visualization.imsave(loss_mask[phase][0],f'loss_mask_{phase}.png')
        # medutils.visualization.imsave(trn_mask[phase][0],f'trn_mask_{phase}.png')
        # medutils.visualization.imsave(inp_mask[2],f'inp_mask_2.png')
